...
% ********************************************************************
\newcommand{\myTitle}{Proyecto \$inTime\xspace}
...
\newcommand{\myKeyWords}{\$inTime, docencia, gamificación}
...
pdftitle = {\myTitle},
pdfsubject = {},
pdfkeywords = {\$inTime, docencia, gamificación, ...},
...
\DeclareAcronym{Ciudadano}{
short = Ciudadano ,
long = Alumno en el papel de ``Ciudadano \$inTime'',
class = abbrev
}
